...
<div class="bottom" style="height:750px;">
 ...
 <br/>
 <center>
<div><img src="success-tick.png"></div><div>You have successfully added an Event&nbsp;<b><?php 
...
<div class="ex" style="margin-left:225px;width:500px;float:left">
   ...
   &nbsp;&nbsp;<b>Event Details</b>
    ...
    <table id="form" border="0" align="center">
		<tr><td>Name:</td><td><?php echo $_SESSION['eventname'];?></td></tr>
		<tr><td>Location:</td><td><?php echo $_SESSION['location'];?></td></tr>
		<tr><td>Date:</td><td><?php echo $_SESSION['date'];?></td></tr>
		<tr><td>Time:</td><td><?php echo $_SESSION['time'];?></td></tr>
		<tr><td>Seating Capacity:</td><td><?php echo $_SESSION['seating'];?></td></tr>
		<tr><td>Description:</td><td><?php echo $_SESSION['description'];?></td></tr>
		<tr><td>Manager:</td><td><?php echo $_SESSION['managerid'];?></td></tr>
