...
<div class="bottom" style="height:450px;">
 ...
 <br/>
 <center>
<div><img src="success-tick.png"></div><div>You have successfully added a Agent&nbsp;<?php 
echo $_SESSION['name'];
?></div>
<br>
<div class="ex" style="margin-left:225px;width:500px;float:left">
   ...
   &nbsp;&nbsp;<b>Agent Details</b>
    ...
    <table id="form" border="0" align="center">
		...
		<tr><td>Office Phone:</td><td><?php echo $_SESSION['phone'];?></td></tr>
		<tr><td>Cell Phone:</td><td><?php echo $_SESSION['cell'];?></td></tr>
		<tr><td>Email:</td><td><?php echo $_SESSION['email'];?></td></tr>
		<tr><td>Address line 1:</td><td><?php echo $_SESSION['addr1'];?></td></tr>
