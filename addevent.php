...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="kogo 9.png">
 ...
 <div class="bottom" style="height:480px;">
 <div id="cssmenu">
  <ul>
...
<div class="ex" style="margin-left:225px;width:500px;float:left">
   ...
   <form name="f1" id="f1" method="post" action="assign.php">
    <table id="form" border="0" align="center">
		<tr><td></td></tr>
		<tr><td>Event Name:</td><td><input type="text" name="name" autocomplete="off" id="name" autofocus required></td></tr>
		<tr><td>Location:</td>
		<td>
		<input type="radio" name="location" class="loc" value="City Hall"><label>City Hall</label></td></tr>
		<tr><td></td><td><input type="radio" class="loc" name="location" value="Old Hall"><label>Old Hall</label></td></tr>
		<tr><td></td><td><input type="radio" class="loc" name="location" value="other" id="other"><label>Other</label><div id="custom"></div></td></tr>
		<tr><td>Date:</td><td><input type="date" name="date" value="<?php echo date(mm/dd/yyyy); ?>"  required /></td></tr>
		<tr><td>Time:</td><td><input type="time"  name="time" required/></td></tr>
		<tr><td>Seating Capacity:</td><td><input type="text" name="seating" id="seating" size="4" autocomplete="off" required></td></tr>
		<tr>
		<td>Manager:</td>
		<td>
		<select name="manager">
		...
		<tr><td>Description:</td><td><textarea name="description" cols="30" rows="3"></textarea></tr>
		<tr><td></td><td><input type="submit" name="add" value="Add Event" id="add">&nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="Clear"</td></tr>
	</table>
   </form>
 </div>
 </div>
