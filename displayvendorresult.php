...
$('#search').click(function() {
    window.location.href = 'http://students.cs.niu.edu/~cs56712/searchvendor.php';
    return false;
});
});
$(document).ready(function(){
...
<div class="ex" style="margin-left:225px;width:500px;float:left">
   ...
   &nbsp;&nbsp;<b>Search Vendor Result </b>
    ...
    <table id="form" border="0" align="center">
		...
		<tr></tr>
		<tr></tr>
		<tr><td></td><td><input type="button" name="search" id="search" value="Search Again"><input type="button" id="update" name="update" value="Update details"></td></tr>
	</table>
   </form>
 </div>
 </div>
