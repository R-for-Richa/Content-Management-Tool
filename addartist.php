...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="kogo 9.png">
 ...
 <center><h2>Add Artist</h2></center>
    <form action="d_add_artist.php" method="post">
	<div class="ex" style="margin-left:70px;width:360px;float:left">
    <div class="heading">&nbsp;&nbsp;<b>Artist Details</b></div>
   <table id="form"  border="0" align="center">
	<tr><td><label>Name:</label></td><td><input type="text" name="ar_name" required></td></tr>
	<tr><td><label>Logo:</label></td><td><input type="file" name="ar_logo" required></td></tr>
	<tr><td><label>Office Phone:</label></td><td><input type="text" name="ar_ophne" required></td></tr>
	<tr><td><label>Cell Phone:</label></td><td><input type="text" name="ar_cphne" required></td></tr>
...
<div class="ex" style="margin-left:0px;margin-right:70px;width:360px;height:265px;float:right">
...
<tr><td><label>Office Phone:</label></td><td><input type="text" name="a_ophne" required></td></tr>
...
<tr><td><label>ZIP:</label></td><td><input type="text" name="ar_zip" maxlength="5" size="5" required></td></tr>
 ...
 <div style="clear:both;position:relative;top:20px;"><center><input type="submit" value="Add Artist" id="addartist" name="addartist">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Clear" id="clear" name="clear"></center></div>
   </form>
