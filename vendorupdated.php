...
<div class="bottom" style="height:450px;">
 ...
 <br/>
 <center>
<div><img src="success-tick.png"></div><div>You have successfully updated Vendor&nbsp;<?php 
...
<div class="ex" style="margin-left:225px;width:500px;float:left">
   ...
   &nbsp;&nbsp;<b>Vendor Details</b>
    ...
    <table id="form" border="0" align="center">
		<tr><td></td></tr>
		<tr><td>Name:</td><td><?php echo $_SESSION['vendorname'];?></td></tr>
		<tr><td>Category:
	    </td><td><?php foreach($_SESSION['category'] as $c)
		{
		if($c=="other")
		{
		$cid=$_SESSION['cid'];
		$result1=mysql_query("select category_name from category where category_id='$cid'");
		$row=mysql_fetch_row($result1);
		echo $row[0]; 
		}
		else
		{
		$result2=mysql_query("select category_name from category where category_id='$c'");
		...
		<tr><td>Office Phone:</td><td><?php echo $_SESSION['officephone'];?></td></tr>
		<tr><td>Cell Phone:</td><td><?php echo $_SESSION['officephone'];?></td></tr>
		<tr><td>Money per Event:</td><td><?php echo $_SESSION['money'];?></td></tr>
		<tr></tr>
		<tr></tr>
